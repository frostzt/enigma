...
TEST(compaction, size_tiered_full_compaction) {
    ...
    storage_engine.do_compact_work();
    ...
    // }
    //
    // auto c = compactor.do_size_tiered_compact(
    //     inputs, storage_engine.get_next_sst_sequence(), true);
    // auto next_id = c.value();
    // ASSERT_TRUE(c.has_value());
    //
    // count = std::count_if(
    //     fs::directory_iterator(testdir.path + "/sst"),
    ...
    // auto sstr =
    //     SSTableReader::create(engine, sst_path(testdir.path, next_id.value));
...
// TEST(compaction, size_tiered_partial_compaction) {
//     PosixIOEngine engine;
//     std::string data_dir_path = "./compaction_tests";
//     Tempdir testdir(data_dir_path);
//
...
//     auto c = compactor.do_size_tiered_compact(
//         inputs, storage_engine.get_next_sst_sequence(), false);
//     auto next_id = c.value();
//     ASSERT_TRUE(c.has_value());
//
//     count = std::count_if(
